module.exports = function(self){
	...
	"simpleTrigger": "how",/*any of these words will flag this action for consideration*/
	"trigger": /how ?(are|do|is|'s) (it|you) (feel|do|go)/i,/*the text must match this exactly (this is a regex) in order for doAction to be triggered*/
